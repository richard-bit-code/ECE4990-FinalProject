[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/richard-bit-code/ECE4990-FinalProject/blob/main/parking_lot_fixed_v2.ipynb)
...
|---|---|---|
| CNRPark-EXT | 0.922 | **0.989** |
| ParkingSlot | 0.978 | 0.922 |
| Combined | 0.967 | 0.961 |

> The proposed model achieves a **+6.7% F1 improvement** over the baseline on CNRPark-EXT, demonstrating the benefit of global attention for cross-slot spatial reasoning.
...
```
├── parking_lot_fixed_v2.ipynb       # Main notebook (Kaggle & Colab)
├── README.md                        # This file
...
2. Click **+ New Notebook** → **File → Import Notebook** → upload `parking_lot_fixed_v2.ipynb`
...
jupyter notebook parking_lot_fixed_v2.ipynb
```
